...
- Harmonize all datasets and build fuzzy logic.
  ...
  - see
[notes on skfuzzy](https://github.com/byandell-envsys/landmapy/blob/main/notes.qmd#fuzzy-logic-model-27-feb-2025)
- Spruce up graphics, possibly using
  - slider widget (see code below in [Climate model data](#climate-model-data) section)
  - matplotlib with multiple subplots (see [6 Mar notes](https://github.com/byandell-envsys/landmapy/blob/main/notes.qmd#notes-6-mar-2025))
