...
-   Harmonize all datasets and build fuzzy logic.
    ...
    -   see [notes on
        skfuzzy](https://github.com/byandell-envsys/landmapyr/blob/main/notes.qmd#fuzzy-logic-model-27-feb-2025)
-   Spruce up graphics, possibly using
    ...
    -   matplotlib with multiple subplots (see [6 Mar
        notes](https://github.com/byandell-envsys/landmapyr/blob/main/notes.qmd#notes-6-mar-2025))
...
from landmapyr.process import da_combine
...
from landmapyr.thredds import process_maca, maca_year # process MACA THREDDS
...
-   [Yandell Fall
    ...
    -   [buffalo.qmd](https://github.com/byandell-envsys/habitatSuitability/blob/main/buffalo.qmd)
        (Quarto source)
    -   [landmapyr](https://github.com/byandell-envsys/landmapyr) (Python
        package)
...
-   [gbif.py](https://github.com/byandell-envsys/landmapyr/blob/main/landmapyr/gbif.py)
    module in [landmapyr](https://github.com/byandell-envsys/landmapyr)
    package
...
-   Fuzzy Logic on images
    -   migrate from my `ramp_logic()` to skfuzzy (see
        [notes_fuzzy.qmd](https://github.com/byandell-envsys/landmapyr/blob/main/notes.qmd#fuzzy-logic-model-27-feb-2025))
