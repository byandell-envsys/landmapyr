...
def read_wbd_file(
    wbd_filename, huc_level=12, cache_key=None, func_key="wbd_08", override=False
):
    """
...
def compute_reflectance_da(
    search_results, boundary_gdf, func_key="delta_reflectance_da_df", override=False
):
    """
...
def merge_and_composite_arrays(
    granule_da_df, func_key="delta_reflectance_da", override=False
):
    """
